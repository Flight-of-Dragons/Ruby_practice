...
oneBillion = birthTime + 1000000000

puts nowTime > oneBillion ? "You turned a billion seconds old on #{oneBillion}." : "You will turn a billion seconds old on #{oneBillion}."
